...
from keras.layers import Conv2D # using for keras ver 2.x
#from keras.layers import concatenate  # using for keras ver 2.x
...
def SSD300(input_shape, num_classes=21, pretrained=True): #ssd300- keras version 1.2
    """SSD300 architecture.
    ...
    return model
'''
def SSD300v2(input_shape, num_classes=21): #ssd300v2- keras version 2.x
    """SSD300 architecture.
     # Arguments
        input_shape: Shape of the input image,
            expected to be either (300, 300, 3) or (3, 300, 300)(not tested).
...
def get_SSD_model():
    ...
    # ssd ver 1.2
    #model_ssd = SSD300v2(input_shape=(300, 300, 3), num_classes=NUM_CLASSES)
